...
export function BrasilcardHeaderSection (): JSX.Element {
  return (
    <header id="solicitar-cartao" className="flex flex-col min-h-[90dvh] items-center justify-end relative w-full bg-transparent">
      ...
      <main className="flex flex-wrap sm:flex-nowrap items-center py-12 gap-3 px-2 md:px-6 lg:px-36 justify-center relative w-full grow bg-[url('/brasilcard-headline-background.png')]">
        <section className="w-full max-w-7xl sm:w-1/2 px-9 h-full gap-y-5 flex flex-col items-start justify-center">
