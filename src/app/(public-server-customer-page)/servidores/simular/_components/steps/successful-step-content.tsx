  ...
  return (
    <div>
      <div className="flex flex-col items-center space-y-2 p-6 sm:py-12">
        <CheckCircleIcon className="hidden sm:flex sm:size-12 sm:text-[#00bf63]" />

        <h1 className="w-60 text-xl text-center font-medium p-4 sm:w-72 sm:text-2xl">
      ...
      <section className="flex flex-col space-y-4 pb-6 px-6 sm:items-center sm:py-8">
