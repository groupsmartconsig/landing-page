...
export function FaqContainer() {
  return (
    <div
      className="bg-gray-200 h-[540px] w-full flex flex-col items-center justify-center overflow-hidden"
    >
      <div className="w-full flex flex-col space-y-12">
        <p className="text-black text-3xl text-center font-bold tracking-tighter md:text-5xl">
          FAQ<br />
