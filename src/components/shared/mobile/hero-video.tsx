...
export function HeroVideoContainer() {
  return (
    <div className="relative pb-16">
      <div className="max-w-[322px] mx-auto w-full flex flex-col justify-center space-y-2 pb-12">
        <h3 className="text-2xl text-primary font-bold sm:px-0 md:text-5xl">
          Depoimentos de Clientes
        </h3>
        <p className="w-full text-base text-muted-foreground font-medium sm:max-w-5xl">
        ...
        <div className="w-full pt-6 sm:max-w-xs sm:px-0">
